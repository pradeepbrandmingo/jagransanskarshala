                ...
                {dobInputMode === "calendar" ? (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-gray-400 mt-1.5 flex items-center gap-1">
                      <FiCalendar className="shrink-0" /> Age 19+ years only / केवल 19 वर्ष या उससे अधिक
                      {form.dob && (() => {
                  ...
                  >
                    <div className={`flex items-stretch rounded-xl border overflow-visible transition-all bg-white ${
                      ...
                      {/* Month — SearchableSelect with showSearch={false} */}
                      <div className="flex-[1.8] min-w-0 flex flex-col justify-center px-1">
                        <SearchableSelect
                          name="dobMonth"
                          value={form.dobMonth}
                          showSearch={false}
